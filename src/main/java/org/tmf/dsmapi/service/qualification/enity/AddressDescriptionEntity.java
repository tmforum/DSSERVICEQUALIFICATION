...
public class AddressDescriptionEntity  implements Serializable {
  ...
  /**
   **/
  public AddressDescriptionEntity streetNr(String streetNr) {
  ...
  /**
   **/
  public AddressDescriptionEntity streetNrSuffix(String streetNrSuffix) {
  ...
  /**
   **/
  public AddressDescriptionEntity streetNrLast(String streetNrLast) {
  ...
  /**
   **/
  public AddressDescriptionEntity streetNrLastSuffix(String streetNrLastSuffix) {
  ...
  /**
   **/
  public AddressDescriptionEntity streetName(String streetName) {
  ...
  /**
   **/
  public AddressDescriptionEntity streetType(String streetType) {
  ...
  /**
   **/
  public AddressDescriptionEntity streetSuffix(String streetSuffix) {
  ...
  /**
   **/
  public AddressDescriptionEntity postcode(String postcode) {
  ...
  /**
   **/
  public AddressDescriptionEntity locality(String locality) {
  ...
  /**
   **/
  public AddressDescriptionEntity city(String city) {
    this.city = city;
    return this;
  }
  ...
  /**
   **/
  public AddressDescriptionEntity stateOrProvince(String stateOrProvince) {
  ...
  /**
   **/
  public AddressDescriptionEntity country(String country) {
  ...
  public boolean equals(Object o) {
    ...
    AddressDescriptionEntity addressDescription = (AddressDescriptionEntity) o;
