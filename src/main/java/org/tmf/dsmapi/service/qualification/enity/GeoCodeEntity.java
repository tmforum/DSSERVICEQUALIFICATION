...
@Entity(name = "GeoCode")
@Table(name = "GEO_CODE")
public class GeoCodeEntity implements Serializable   {
   ...
   * @return 
   */
  public GeoCodeEntity latitude(String latitude) {
   ...
   * @return 
   */
  public GeoCodeEntity longitude(String longitude) {
   ...
   * @return 
   */
  public GeoCodeEntity geographicDatum(String geographicDatum) {
  ...
  public boolean equals(Object o) {
    ...
    GeoCodeEntity geoCode = (GeoCodeEntity) o;
