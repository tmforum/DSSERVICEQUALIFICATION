...
public class ServiceSpecificationCharacteristic implements Serializable {
     ...
     * @return
     */
    public ServiceSpecificationCharacteristic id(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return
     */
    public ServiceSpecificationCharacteristic name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return
     */
    public ServiceSpecificationCharacteristic valuefrom(String valuefrom) {
     ...
     * @return
     */
    public ServiceSpecificationCharacteristic valueto(String valueto) {
    ...
    public boolean equals(Object o) {
        ...
        ServiceSpecificationCharacteristic serviceSpecificationCharacteristic = (ServiceSpecificationCharacteristic) o;
